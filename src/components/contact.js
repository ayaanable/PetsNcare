          ...
          <div className="contact-content4">
            ...
            <div className="contact-contact-info2">
              <div className="contact-content5">
                ...
                <p className="thq-body-large">{props.content4}</p>
              </div>
...
Contact.defaultProps = {
  ...
  address1: '123 Pet Street, Cityville, USA',
  content2: 'We are here to help with any inquiries you may have.',
  content5: 'Thank you for visiting our website!',
  email1: 'info@petswebsite.com',
  phone1: '+1-800-PETS-123',
}
